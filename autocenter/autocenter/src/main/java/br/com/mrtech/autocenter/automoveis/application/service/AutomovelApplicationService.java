...
public class AutomovelApplicationService implements AutomovelService{
    ...
    @Override
    public void alteraMarcaParaHyundai(UUID idAutomovel) {
        log.info("[inicia] AutomovelApplicationService - alteraMarcaParaHyundai");
        Automovel automovel = repository.buscaAutomovelId(idAutomovel);
        automovel.alteraParaHyundai();
        repository.salva(automovel);
        log.info("[finaliza] AutomovelApplicationService - alteraMarcaParaHyundai");
    }
    ...
    @Override
    public void alteraTipoParaPicape(UUID idAutomovel) {
    ...
    @Override
    public void alteraTipoParaCupe(UUID idAutomovel) {
        log.info("[inicia] AutomovelAplicationService - alteraTipoParaCupe");
        Automovel automovel = repository.buscaAutomovelId(idAutomovel);
        automovel.alteraParaCupe();
        repository.salva(automovel);
        log.info("[finaliza] AutomovelAplicationService - alteraTipoParaCupe");
    }
